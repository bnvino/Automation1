...
namespace TestSeleniumWebDriver.TestScript.DropDownList
{
    [TestClass]
    public class HandleDropDownList
    {
        ...
        public void TestDropDownList()
        {
            ...
            DropDownListHelper.SelectElement(By.Id("bug_severity"), "blocker");

            foreach (string str in DropDownListHelper.GetAllItem(By.Id("bug_severity")))
            {
